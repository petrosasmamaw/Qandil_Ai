...
import { FiCpu, FiLock, FiMail } from "react-icons/fi";
    ...
    <div className="w-full max-w-md p-8 rounded-2xl bg-slate-900 shadow-2xl border border-slate-800">
      <div className="mb-6 text-center">
        ...
        <h2 className="text-2xl font-bold text-white mb-1">
          Welcome back to <span className="text-blue-400">Qandil!</span>
        </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between text-sm pt-1">
          <label className="flex items-center gap-2 text-slate-400 cursor-pointer">
            <input type="checkbox" className="rounded bg-slate-800 border-slate-700 text-blue-500 focus:ring-blue-500" />
            Remember me
          </label>
          <button
            type="button"
